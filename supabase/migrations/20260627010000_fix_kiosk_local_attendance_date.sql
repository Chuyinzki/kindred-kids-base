...
DECLARE
  ...
  attendance_date DATE := (now() AT TIME ZONE 'America/Los_Angeles')::DATE;
BEGIN
...
DECLARE
  ...
  attendance_date DATE := (now_ts AT TIME ZONE 'America/Los_Angeles')::DATE;
  child_name TEXT;
BEGIN
  SELECT ks.provider_id
  INTO session_provider_id
  ...
  IF NOT FOUND THEN
    ...
    VALUES (child_uuid, attendance_date)
